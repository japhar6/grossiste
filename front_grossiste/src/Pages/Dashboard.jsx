...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchFournisseursCount = async () => {
      try {
        const response = await fetch('https://api.bazariko.duckdns.org/api/fournisseurs/count');
  ...
  useEffect(() => {
    ...
    const fetchCommandecount = async () => {
      try {
        const response = await fetch('https://api.bazariko.duckdns.org/api/commandes/count');
        const data = await response.json();
  ...
  useEffect(() => {
    ...
    const fetchClientCount = async () => {
      try {
        const response = await fetch('https://api.bazariko.duckdns.org/api/client/count');
        const data = await response.json();
  ...
  useEffect(() => {
    ...
    const fetchproduitCount = async () => {
      try {
        const response = await fetch('https://api.bazariko.duckdns.org/api/produits/count');
        const data = await response.json();
